...
void drive(directionType dir, int dist, distanceUnits units) {
  ...
  RightChassis1.spinFor(dir, dist/(M_PI*wheelDiameter*unitNorm), turns, false);
  LeftChassis1.spinFor(dir, dist/(M_PI*wheelDiameter*unitNorm), turns, false);
...
void liftSpeed(int speed){
  ArmMotor1.setVelocity(speed, percent);
  ArmMotor2.setVelocity(speed, percent);
}
