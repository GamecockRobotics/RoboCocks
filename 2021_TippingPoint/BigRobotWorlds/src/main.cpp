...
void driveForward(int dist, bool waiting = true) {
  ...
  driveFrontLeft.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                             360,
                         degrees, false);
  driveMiddleLeft.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                              360,
                          degrees, false);
  driveBackLeft.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                            360,
                        degrees, false);
  driveFrontRight.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                              360,
                          degrees, false);
  driveMiddleRight.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                               360,
                           degrees, false);
  driveBackRight.spinFor(dist * M_1_PI / WHEEL_DIAMETER * CHASSIS_GEAR_RATIO *
                             360,
                         degrees, waiting);
}
...
void usercontrol(void) {
  ...
  Controller1.ButtonA.pressed(toggle);
  while (1) {
